...
This is required for securities lending trades that are collateralised by other securities, where the securities being used as collateral may need to be defined on the trade too.

_What is being released?_

The following changes have been made:

- A new type of `PositionBase` has been introduced.
